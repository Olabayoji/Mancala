...
public class ApprovalController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        btnBack.setOnMouseClicked(mouseEvent -> handleBackButtonClick(mouseEvent));
    ...
    /**
     * Handles the back button click event by navigating back to the AdminMenu.
     *
     * @param mouseEvent The MouseEvent generated by the button click.
     */
    private void handleBackButtonClick(MouseEvent mouseEvent) {
        try {
